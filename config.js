...
export const getSearchTags = `http://localhost:3000/static/data/taglist.json`;
export const getTagWdlist = `http://localhost:3000/static/data/wdlistitems.json`;
export const dashBoardResumeDetail = `http://localhost:3000/static/data/dashRdetail.json`;
