...
export const inicischeck = `${APIURL}/company/matchup/purchase`;
export const inipre = `${APIURL}/company/matchup/prepare`;
export const dashboardadr = `${APIURL}/company/job-ad/home`;
